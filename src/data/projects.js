...
export const projects = [
  {
    ...
    heroMedia: {
      type: 'embed',
      src: 'https://www.youtube.com/embed/iBT9T-GgzLc',
      poster: '/images/projects/refrigerator/thumbnail.jpg',
      alt: '약품고 대표 영상',
      caption: '약품고 Edge 시스템 시연 영상 (YouTube)',
    },
  ...
  },
  {
    ...
    heroMedia: {
      type: 'embed',
      src: 'https://www.youtube.com/embed/J3a1aG9tYj8',
      poster: '/images/projects/smart_logistics/thumbnail.png',
      alt: '지능형 물류 운반/적재 통합 제어 및 디지털 트윈 플랫폼 대표 영상',
      caption: '지능형 물류 운반/적재 통합 제어 및 디지털 트윈 플랫폼 추론 영상 (YouTube)',
    },
    techStack: [
      'YOLOv8-OBB',
      'Domain Adaptation',
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          ...
          {
            type: 'embed',
            src: 'https://www.youtube.com/embed/MQbvahW060A',
            poster: '/images/projects/smart_logistics/thumbnail.png',
            caption: '스마트물류 시뮬레이션영상',
          },
          {
            type: 'embed',
            src: 'https://www.youtube.com/embed/SDdcM5qV7Wk',
            poster: '/images/projects/smart_logistics/thumbnail.png',
            caption: '스마트물류 현실영상',
          },
        ],
